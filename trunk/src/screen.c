...
screen_t * screen_new() {
  SDL_Surface *video = SDL_SetVideoMode(640,480,8,SDL_HWSURFACE | SDL_HWPALETTE | SDL_DOUBLEBUF | SDL_FULLSCREEN);
  //SDL_Surface *video = SDL_SetVideoMode(640,480,8,SDL_HWSURFACE | SDL_HWPALETTE | SDL_DOUBLEBUF);
